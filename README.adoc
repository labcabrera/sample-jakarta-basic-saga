...
Ejemplo de implementación SAGA coreografiada utilizando Jakarta EE sin dependencias adicionales. La aplicación define una librería básica para hacer el binding con sistemas de mensajería (Kafka y RabbitMQ en este ejemplo) para tener una interface independiente de la implementación a la hora de consumir y publicar los eventos.

El objetivo de este ejemplo es mostrar una implementación sencilla sin utilizar frameworks adicionales como Axon o Eventuate.
