...
|_jakarta-stream-binder_ | Librería de abstracción para la integración con sistemas
                           de mensajería (también podría utilizarse para otros mecanismos
                           como por ejemplo enviar un correo o registrar una incidencia en
                           un sistema de ticketing pero para nuestro propósito de la demo
                           estará enfocado a proporcionar una interface limpia para utilizar
                           un broker).
|_jakarta-stream-binder-kafka_  | Implementación de interfaces de de la librería de bindeo específicas
                                  de Kafka.
|_jakarta-stream-binder-rabbit_ | Implementación de interfaces de de la librería de bindeo específicas
                                  de RabbitMQ.
